...
<body onload="errorAlert()">
    ...
    <!-- https://www.w3schools.com/howto/howto_css_login_form.asp -->
        ...
        <?php
            ...
            if (isset($_SESSION["name"])) // if name is set, show logout option
            {
                // allows user to logout 
                echo '
                    <section id="loginSection" class="container">
                        <form id="logout" action="logoutActionPage.php" method="post">
            ...
            else // if user is logged in, give them the opportunity to log out
            {
                echo '
